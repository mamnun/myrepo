...
libraries["ssl"] = ctypes.cdll.LoadLibrary("libcrypto.so")


EVP_cleanup = libraries['ssl'].EVP_cleanup
EVP_cleanup.restype = ctypes.c_int
EVP_cleanup.argtypes = []

ERR_free_strings = libraries['ssl'].ERR_free_strings
ERR_free_strings.restype = ctypes.c_int
...
OpenSSL_add_all_digests = libraries['ssl'].OPENSSL_add_all_algorithms_conf
...
EVP_aes_128_cbc = libraries['ssl'].EVP_aes_128_cbc
EVP_aes_128_cbc.restype = ctypes.c_void_p
EVP_aes_128_cbc.argtypes = []


EVP_aes_256_cbc = libraries['ssl'].EVP_aes_256_cbc
